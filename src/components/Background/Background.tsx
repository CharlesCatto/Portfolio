...
// // 		do {
// // 			size = Math.floor(Math.random() * 750) + 250; // Taille entre 250px et 1000px
...
// // 		// Limitation de la vitesse entre 10s et 50s
// // 		const speed = Math.max(40, Math.min(50, 80 - size / 10));

// // 		clouds.push({ id: i, size, top, speed });
// // 	}
...
// 		clouds.push({ id: i, size, top, speed, image });
// 	}
...
// 		// Générer les nuages progressivement avec un délai aléatoire
